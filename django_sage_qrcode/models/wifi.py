...
class WifiQRCode(QRCode):
    ...
    ssid = models.CharField(
        ...
        db_comment=_("The SSID of the WiFi network."),
        verbose_name=_("SSID"),
    )
    password = models.CharField(
        max_length=255,
        help_text=_("Password of the WiFi network."),
        db_comment=_("The password for the WiFi network."),
    ...
    security = models.CharField(
        ...
        db_comment=_("The security type for the WiFi network (e.g., WPA, WPA2)."),
