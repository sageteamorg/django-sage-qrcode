...
class QRCode(PolymorphicModel, TimestampMixin):
    ...
    qr_code_image = models.ImageField(
        ...
        db_comment=_("The image file of the generated QR code."),
    )
    custom_gif = models.ImageField(
        ...
        db_comment=_("An optional custom GIF that can be embedded in the QR code."),
    )
    title = models.CharField(
        ...
        db_comment=_("A descriptive title for the QR code."),
    )
    size = models.PositiveSmallIntegerField(
        ...
        null=True,
        blank=True,
        db_comment=_("The size (dimensions) of the QR code image."),
    )
    color = ColorField(
        format="hex",
        ...
        null=True,
        blank=True,
        db_comment=_("The color of the QR code in hexadecimal format."),
    )
    second_color = ColorField(
        ...
        null=True,
        blank=True,
        db_comment=_("The second color of the QR code in hexadecimal format."),
    )
